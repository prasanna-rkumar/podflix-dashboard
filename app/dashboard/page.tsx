...
export default function DashboardPage() {
  ...
  const { isLoading, fetchStatus, data } = trpc.getShowEpisodes.useQuery(
    { url, pageNumber },
    {
  ...
  const { mutate: addEpisodeToAccount } = trpc.addEpisodeToAccount.useMutation();
    ...
    <div className="w-full max-w-4xl mx-auto py-12 px-4 md:px-6">
      <div className="space-y-4 flex flex-col items-center">
        <div className="text-center">
          <h1 className="text-3xl font-bold">Link you Podcast Show</h1>
          <p className="text-muted-foreground">Enter your podcast RSS URL to choose an episode.</p>
        </div>
